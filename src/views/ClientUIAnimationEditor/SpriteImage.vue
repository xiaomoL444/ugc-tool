<template>
  <svg class="sprite-image" :viewBox="`0 0 ${width} ${height}`" preserveAspectRatio="none" aria-hidden="true">
...
import type { ColorRGBA, UIImageType } from "./types";
const props = defineProps<{ asset: UIImageAsset | null; width: number; height: number; imageType: UIImageType | null; color: ColorRGBA }>();
